About satmad-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/satmad-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10201&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/satmad-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `satmad` can be installed with `conda`:
...
```
mamba install satmad
```

It is possible to list all of the versions of `satmad` available on your platform with `conda`:
...
```
mamba search satmad --channel conda-forge
```
...
mamba repoquery search satmad --channel conda-forge

# List packages depending on `satmad`:
mamba repoquery whoneeds satmad --channel conda-forge

# List dependencies of `satmad`:
mamba repoquery depends satmad --channel conda-forge
```
